...
public interface  ManagerMapper {
	...
	@Insert("insert into student(stu_id,stu_name,stu_addr,stu_phone,stu_email) values"
			+"(#{stu_id},#{stu_name},#{stu_addr},#{stu_phone},#{stu_email})")
	...
	@Insert("insert into teacher(teac_id,teac_name,teac_addr,teac_phone,teac_email,teac_title,teac_time) values"
			+"(#{teac_id},#{teac_name},#{teac_addr},#{teac_phone},#{teac_email},#{teac_title},#{teac_time})")
